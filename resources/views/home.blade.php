                    ...
                    <div class="row">
                       <div class="col-md-4">
                          <center>
                            ...
                            <h6>Users</h6>  
                            <h1>{{ App\User::where('is_active', 1)->count()}}</h1>
                          </center>
                        </div>
                        ...
                        <div class="col-md-4">
                          <center>
                            ...
                            <h1>{{ App\Models\Subjects::where('is_active', 1)->whereNotNull('user_id')->count()}}</h1>
                          </center>
                        </div>
                        ...
                        <div class="col-md-4">
                          <center>
                            ...
                            <h1>{{ App\ExamRecord::where('pass_fail', 'pass')->count()}}</h1>
                          </center>
                        </div>
                    </div>
                </div>
