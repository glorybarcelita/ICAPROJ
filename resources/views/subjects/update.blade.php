...
<a href="{{ URL::previous() }}" class="col-sm-3 btn btn-md btn-outline-secondary float-right mr-3">Go Back</a>
<br>
...
$(function(){
  ...
  @foreach(App\Models\SubjectCourse::where('subject_id', $subjects->id)->get() as $course_id)
